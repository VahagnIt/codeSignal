...
// The middle consists of two elements, 2 and 5. These two elements should be replaced with their sum, i.e.
// 7.
...
function replaceMiddle(arr) {
  ...
  let sum = arr.splice(arr.length / 2 - 1, 2).reduce((a, b) => a + b);
  arr.splice(arr.length / 2, 0, sum);
  return arr;
}
