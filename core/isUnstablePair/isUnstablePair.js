// Some file managers sort filenames taking into account case of the letters, others
// compare strings as if all of the letters are of the same case. That may lead to different
// ways of filename ordering.
...
function isUnstablePair(filename1, filename2) {
  return (
    filename1 < filename2 !==
      filename1.toUpperCase() < filename2.toUpperCase() ||
